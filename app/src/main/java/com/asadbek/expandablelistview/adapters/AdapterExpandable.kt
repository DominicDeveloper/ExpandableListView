package com.asadbek.expandablelistview.adapters
...
import com.asadbek.expandablelistview.R
...
class AdapterExpandable(var title:List<String>,var map:HashMap<String,List<String>>):BaseExpandableListAdapter(){
    ...
    // asosiy funksiya group view uchun
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int,
        ...
        itemView.findViewById<TextView>(R.id.itemChildText).text = txt
